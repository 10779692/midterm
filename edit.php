...
//BUILD THE QUERY
$sql = "INSERT INTO employees (fullname, expertise, phone, email, paragraph, photo ) VALUES ('$fullname','$expertise','$phone','$email','$paragraph,'$filename')";
...
<h1>Edit Employee</h1>
  ...
  <div class="form-group">
    <label for="exampleFormControlFile1">Upload New Employee Photo</label>
  ...
  <button type="submit" name="submit" value="Add Member" class="btn btn-primary mb-2">Edit Employee</button>
  </div>
